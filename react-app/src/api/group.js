...
export const fetchMyJoinedGroups = (targetId) =>
  axios.get(`${url}/joined?targetId=${targetId}`);
export const fetchMyOwnedGroups = (targetId) =>
  axios.get(`${url}/owned?targetId=${targetId}`);
...
export const updateGroup = (updatedGroup) =>
  axios.put(`${url}/${updatedGroup._id}`, updatedGroup);
export const deleteGroup = (groupid) => axios.delete(`${url}/${groupid}`);
export const transferGroup = (groupid, userid) =>
  axios.put(`${url}/transfer/${groupid}?targetId=${userid}`);
export const removeMemberFromGroup = (groupid, userid) =>
  axios.put(`${url}/remove/${groupid}?targetId=${userid}`);

export const joinGroup = (groupid) => axios.put(`${url}/join/${groupid}`);
export const quitGroup = async (groupid) => {
  return axios.put(`${url}/quit/${groupid}`).catch((error) => {
