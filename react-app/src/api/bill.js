...
export const getAllBillbyChannel = (channelId) =>
  axios.get(`${url}/all?channelId=${channelId}`);
export const getAllBillbyDatePlan = (datePlanId) =>
  axios.get(`${url}/all?datePlanId=${datePlanId}`);
export const getBill = (billId) => axios.get(`${url}/${billId}`);
export const updateBill = (updatedBill) =>
  axios.put(`${url}/${updatedBill._id}`, updatedBill);
