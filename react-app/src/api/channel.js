...
export const editChannel = (updatedChannel) =>
  axios.put(`${url}/${updatedChannel._id}`, updatedChannel);
export const getChannel = (channelId) => axios.get(`${url}/${channelId}`);
export const deleteChannel = (channelId) => axios.delete(`${url}/${channelId}`);
export const fetchMyOwnedChannels = (groupid) =>
  axios.get(`${url}/owned/${groupid}`);
export const fetchMyJoinedChannels = (groupid) =>
  axios.get(`${url}/joined/${groupid}`);
export const removeMember = (channelId, userId) =>
  axios.put(`${url}/remove/${channelId}?targetId=${userId}`);
