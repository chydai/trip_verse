...
export const createPlace = (newPlace, planId) =>
  axios.post(`${url}/${planId}`, newPlace);
export const fetchAllPlace = (planId) => axios.get(`${url}/all/${planId}`);
export const updatePlace = (updatedPlace) =>
  axios.put(`${url}/${updatedPlace._id}`, updatedPlace);
