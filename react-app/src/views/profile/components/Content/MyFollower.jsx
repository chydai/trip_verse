import { Flex, Avatar, Heading, Text, Wrap, WrapItem, Box } from '@chakra-ui/react';
...
function MyFollower() {
    ...
    const [curFollower, setCurFollower] = useState([]);

    useEffect(() => {
        Promise.all(
            curUser.followers.map((userId) =>
                getUser(userId)
            ...
            .then((userObjects) => {
                ...
                setCurFollower(people);
                console.log('follower:', people);
            })
            .catch((error) => {
