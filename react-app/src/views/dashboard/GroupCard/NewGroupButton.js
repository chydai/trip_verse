...
const NewGroupButton = () => {
    ...
    return (
        <Box display="flex" justifyContent="flex-end">
            <AnimateButton>
                <Button variant="contained" color="warning" sx={{ boxShadow: 'none', height: 30 }} onClick={handleOpen}>
                    Create New Group
                </Button>
                <Dialog open={open} onClose={handleClose}>
                    ...
                    <DialogContent>
                        ...
                        >
                            <DatePickerValue value={groupStartDate} onSave={setgroupStartDate} title="Start Date" />
                            <DatePickerValue value={groupEndDate} onSave={setgroupEndDate} title="End Date" />
                        </Box>
                        ...
                        {isError === 1 &&
                            (
                                <Alert
                                    ...
                                    onClose={() => { setIsError(0) }} severity="error">This is an error alert — Start Date cannot be later than End Date!</Alert>
                            )
                        }
                    </DialogContent>
                    <DialogActions>
