...
import { Button, Divider, Avatar,
        ListItem, List,
        ListItemText, 
        Collapse, ListItemAvatar, ListItemButton, IconButton, 
...
import { createComment, fetchCommentByPlace, deleteCommentById } from 'api/comment';
...
const InCardList = (props) => {
    ...
    const handleSaveEdit = () => {
        ...
        createComment({ placeId: temp._id, userId: curUser._id, content: content })
        .then((response) => {
            ...
            <Grid item xs={12}>
                ...
                >
                    ...
                    <Dialog open={openBill} onClose={handleClose}>
                        ...
                        <DialogContent>
                            <BillForm onClick={handleClose} description={temp.name} datePlanID={props.datePlanID} />
                        </DialogContent>
