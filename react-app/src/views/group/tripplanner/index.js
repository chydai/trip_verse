...
const ModeSelect = (props) => {
    ...
    const [selectedInd, setSelectedInd] = useState(props.customization.travelMode);
        ...
        >
            <Button
                sx={{
                    ...
                    background: selectedInd === 0 ? theme.palette.secondary.light : 'inherit',
                    '&:hover': {
            ...
            <Button
                sx={{
                    ...
                    background: selectedInd === 1 ? theme.palette.secondary.light : 'inherit',
                    '&:hover': {
                        background: theme.palette.secondary.dark,
                        color: theme.palette.secondary.light
                    }
            ...
            <Button
                sx={{
                    ...
                    background: selectedInd === 2 ? theme.palette.secondary.light : 'inherit',
                    '&:hover': {
                        background: theme.palette.secondary.dark,
                        color: theme.palette.secondary.light
                    }
...
const TripPlan = () => {
    ...
    return (
        ...
        <MainCard style={{ height: '600px', overflow: 'hidden' }} title="Trip Planner" secondary={<ModeSelect customization={customization} />} >
            <PerfectScrollbar
                component="div"
                style={{
                    height:  '480px' ,
